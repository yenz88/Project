...
Initial Analysis
\vspace{12pt}
\\* Based on our experimental results collected, we can see a clear trend across all four drinks at each point in time. At t = 0.5 minutes, it is obvious that the cup with the most amount of ice, at 75\% of the cup filled (not by volume but by height of the cup), the subjects experienced the most satisfaction. 
